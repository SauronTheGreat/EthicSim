...
(function(d) {
  ...
  d.extend(d.ui.draggable, {version:"1.8.14"});
...
(function(d) {
  ...
  d.extend(d.ui.droppable, {version:"1.8.14"});
...
(function(e) {
  ...
  e.extend(e.ui.resizable, {version:"1.8.14"});
...
(function(e) {
  ...
  e.extend(e.ui.selectable, {version:"1.8.14"})
})(jQuery);
;
/*
...
(function(d) {
  ...
  d.extend(d.ui.sortable, {version:"1.8.14"})
})(jQuery);
;
/*
...
(function(c) {
  ...
  c.extend(c.ui.accordion, {version:"1.8.14",
...
(function(b) {
  ...
  b.widget("ui.button", {options:{disabled:null,text:true,label:null,icons:{primary:null,secondary:null}},_create:function() {
	...
	widget:function() {
	  ...
	  if (a === "disabled")c ? this.element.attr("disabled", true) : this.element.removeAttr("disabled"); else this._resetButton()
	},refresh:function() {
	  ...
	  if (this.type === "radio")k(this.element[0]).each(function() {
		b(this).is(":checked") ? b(this).button("widget").addClass("ui-state-active").attr("aria-pressed", true) :
				b(this).button("widget").removeClass("ui-state-active").attr("aria-pressed", false)
...
(function(c, l) {
  ...
  c.extend(c.ui.dialog, {version:"1.8.14",uuid:0,maxZ:0,getTitleId:function(a) {
	a = a.attr("id");
	if (!a) {
	  this.uuid += 1;
	  a = this.uuid
...
(function(d, p) {
  ...
  d.extend(d.ui.tabs, {version:"1.8.14"});
...
jQuery.effects || function(f, j) {
  ...
  f.extend(f.effects, {version:"1.8.14",save:function(c, a) {
