class FacilitatorsController < ApplicationController
  ...
  def new
	...
	@old_facilitator=Facilitator.find_by_facilitator_group_id(params[:fgid])
	if (!@old_facilitator.nil?)
	  @old_facilitator.destroy
  ...
  def create
	...
	respond_to do |format|
	  if @facilitator.save
		@facilitator_group=FacilitatorGroup.find(@facilitator.facilitator_group_id)
		@facilitator_group.facilitator_id=@facilitator.id
